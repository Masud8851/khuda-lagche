				...
				<div className="row">
					<div className="col-md-4">
						<div className="feature-box">
							...
							<p>
								Ehungry is a restaurant site. <br /> With this you can order the
								food of your choice online.
							</p>
						</div>
					</div>
					<div className="col-md-4 my-5 my-md-0">
						<div className="feature-box">
							...
							<p>
								Ehungry is a restaurant site. With this <br /> you can order the
								food of your choice online.
							</p>
						</div>
					</div>
					<div className="col-md-4">
						<div className="feature-box">
							...
							<p>
								Ehungry is a restaurant site. With this you can order <br /> the
								food of your choice online.
							</p>
						</div>
					</div>
